    ...
    partial class ApplicationForm
    {
        private void SearchData()
        {
            ...
            if (PAR_PA_APPLICATION_ID != null && PAR_PA_APPLICATION_ID.APP_ID != null)
            {
                ...
                {
                    chk_ekyc_pass.Visible = chk_ekyc_not_pass.Visible = chk_ekyc_none.Visible = chk_ekyc_wait_verify.Visible = btn_load_ekyc_status.Visible =ekycDetailExterlink.Visible =  true;
                    CheckEKYC();
                }
            }
