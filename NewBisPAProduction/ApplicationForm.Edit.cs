                                    ...
                                    if (uApplication.LIFE_ID != null && (!String.IsNullOrEmpty(uApplication.LIFE_ID.PL_CODE)))
                                    {
                                        ...
                                        if (uLifeID.ISU_DT != null)
                                        {
                                            ...
                                            else if (channelTypeList.Contains(channelType))
                                            {
                                                if (amountDay < -30)
                                                {
                                                    issuDateOverDate = "วันเริ่มคุ้มครองล่วงหน้าเกิน 30 วัน";
                                                }
                                            }
                                            ...
                                            if (workGroup == "BNC")
                                            {
                                                ...
                                                {
                                                    issuDateOverDate = "วันเริ่มคุ้มครองย้อนหลังเกิน 90 วัน";
                                                }
                                            }
                                            else
                                            {
                                                if (!(channelType.Contains(channelType)))
                                                {
                                                    if (amountDay > 30)
                                                    {
                                                        issuDateOverDate = "วันเริ่มคุ้มครองย้อนหลังเกิน 30 วัน";
                                                    }
                                                }
                                            }
                                        }

                                        if (!string.IsNullOrEmpty(issuDateOverDate))
                                        {
                                            var confirmResult = MessageBox.Show("คุณต้องการออกกธ. ที่มี" + issuDateOverDate + " หรือไม่", "คำเตือน", MessageBoxButtons.YesNo);
                                            if (confirmResult != DialogResult.Yes)
                                            {
                                                throw new Exception(issuDateOverDate);
                                            }
                                        }
                                    }
