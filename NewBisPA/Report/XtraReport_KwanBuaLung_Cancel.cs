...
namespace NewBisPA
{
    public partial class XtraReport_KwanBuaLung_Cancel : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReport_KwanBuaLung_Cancel(NewBISSvcRef.REPORT_KWANBUALUNG_CANCEL[] dataObject, DateTime? ST, DateTime? EN, string TITLE, string POLICY_HOLDING)
        {
            InitializeComponent();
